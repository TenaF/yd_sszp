...
#ifndef __hello2dx__PokerPlayerInfo_fruit__
#define __hello2dx__PokerPlayerInfo_fruit__
...
namespace fruit
{
	...
	public:
		...
		inline void setNickName(string nickName) { m_NickName = nickName; }
		inline string getNickName() { return m_NickName; }
