...
namespace fruit
{
	...
	bool SettingLayer::init()
	{
		...
		auto pRoot = cocostudio::GUIReader::getInstance()->widgetFromJsonFile(SETPATH("fruit/Setting.json").c_str());
		...
		{
			music_Btn->loadTextureNormal(SETPATH("fruit/setting/off.png").c_str());
		}
		else
		{
			music_Btn->loadTextureNormal(SETPATH("fruit/setting/no.png").c_str());
		}
		...
		{
			sound_Btn->loadTextureNormal(SETPATH("fruit/setting/off.png").c_str());
		}
		else
		{
			sound_Btn->loadTextureNormal(SETPATH("fruit/setting/no.png").c_str());
		}
	...
	void SettingLayer::touchButton(Object * obj, cocos2d::ui::TouchEventType eventType)
	{
		...
		if (eventType == cocos2d::ui::TouchEventType::TOUCH_EVENT_ENDED)
		{
			...
			case SETTING_MUSIC:
			{
								  ...
								  {
									  SoundManager::instance()->playBgMusic(SETPATH("fruit/sound/BetBk.mp3").c_str());
									  music_Btn->loadTextureNormal(SETPATH("fruit/setting/no.png").c_str());
								  }
			}
				break;
