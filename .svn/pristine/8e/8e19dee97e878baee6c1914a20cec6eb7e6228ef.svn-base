...
#define TAG "InputPassword"
	...
	InputPassword::InputPassword(InputPasswordListener* listener)
	{
		...
		m_pBg = ImageView::create(SETPATH("hhsw/table/inputpassword/bg.png"));
		m_pBg->setTag(TAG_BG);
		m_pBg->setPosition(Vec2(visible / 2));
		addChild(m_pBg);

		auto newroomlabel = ImageView::create(SETPATH("hhsw/table/inputpassword/label_newroom.png"));
		newroomlabel->setTag(TAG_LABEL_NEWROOM);
		newroomlabel->setPosition(Vec2(350, 363));
		m_pBg->addChild(newroomlabel);

		auto enterroomlabel = ImageView::create(SETPATH("hhsw/table/inputpassword/label_enterroom.png"));
		enterroomlabel->setTag(TAG_LABEL_ENTERROOM);
		enterroomlabel->setPosition(Vec2(280, 363));
		m_pBg->addChild(enterroomlabel);

		auto passwordBox = EditBox::create(CCSize(504, 81), Scale9Sprite::create(SETPATH("hhsw/table/inputpassword/edit_password.png")));
		...
		// btn
		auto btn_cancel = Button::create(SETPATH("hhsw/table/inputpassword/btn_cancel_n.png"), SETPATH("hhsw/table/inputpassword/btn_cancel_d.png"), SETPATH("hhsw/table/inputpassword/btn_cancel_d.png"));
		...
		// enter btn
		auto btn_enter = Button::create(SETPATH("hhsw/table/inputpassword/btn_enter_n.png"), SETPATH("hhsw/table/inputpassword/btn_enter_d.png"), SETPATH("hhsw/table/inputpassword/btn_enter_d.png"));
		...
		//new btn
		auto btn_new = Button::create(SETPATH("hhsw/table/inputpassword/btn_new_n.png"), SETPATH("hhsw/table/inputpassword/btn_new_d.png"), SETPATH("hhsw/table/inputpassword/btn_new_d.png"));
