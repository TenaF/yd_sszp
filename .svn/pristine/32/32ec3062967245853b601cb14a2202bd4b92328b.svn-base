...
namespace sszp
{
	...
	bool helpLayer::init()
	{
		...
		auto pRoot = cocostudio::GUIReader::getInstance()->widgetFromJsonFile(SETPATH("sszp/helpLayer.json").c_str());
		...
		auto help_bg = Sprite::create(SETPATH("sszp/sszp_png/help_bg.png").c_str());
		if (help_bg)
		{
