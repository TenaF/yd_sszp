#ifndef CMD_BACCARAT_HEAD_FILE_FRUIT
#define CMD_BACCARAT_HEAD_FILE_FRUIT
#include "sdk/sdk.h"
#pragma pack(1)
namespace fruit{
//////////////////////////////////////////////////////////////////////////
...
//2017-8-30
#define SUB_S_BUTTON_RIGHT			116									//向右取出分数
#define SUB_S_BUTTON_LEFT			117									//向左加分

//2017-9-4
#define SUB_S_REPEAT_PLACE_JETTON   118									//复投成功
...
//2017-8-30右移金币 or 不比大小返回结构
struct CMD_S_ButtonRight
{
	LONGLONG						lUserRightScore;					//右移后赢的金币
	LONGLONG						LChangeScore;						//筹码
};
//2017-8-30左移添加后的金币
struct CMD_S_ButtonLeft
{
	LONGLONG						lUserLeftScore;						//左移后金币
	LONGLONG						LChangeScore;						//筹码
};
//////////////////////////////////////////////////////////////////////////
//客户端命令结构
...
#define SUB_C_STARTSCROLL			12									//开始滚动 --2017-8-29
#define SUB_C_BUTTON_RIGHT			13									//向右取出分数
#define SUB_C_BUTTON_LEFT			14									//向左加分
#define SUB_C_REPEAT_JETTON			15									//复投下注

//2017-8-30启动or停止猜大小
struct CMD_C_StartRoll
{
	bool							bStartOrStop;						//启动or停止猜大小
};
