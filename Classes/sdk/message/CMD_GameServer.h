...
#define SUB_GR_LOGON_ANDROID		4									//机器人ID登录

//2016-3-28
#define SUB_GR_LOGONROOM_GETKEY				4							//客户端请求KEY子指令
#define SUB_GR_LOGONROOM_GETKEY_SUCCESS		5							//服务端发送生成的RSA加密的RC4 KEY给客户端
...
#define SUB_GR_CONFIG_MOBILE_ROOM_BASEDATA	106							//移动基础数据

//////////////////////////////////////////////////////////////////////////////////
struct MSG_GR_ConfigMobileBaseData
{
	SCORE	lBaseScore;
};
...
#define SUB_GR_MOBILE_USER_STATUS	104									//移动用户状态
...
#define SUB_GR_VERIFY_INSURE_PASS	6									//验证银行密码
#define SUB_GR_WECHAT_CODE_BACK		7									//微信验证码
#define SUB_GR_WECHAT_CODE_BACK1	8									//微信验证码
#define SUB_GR_MODIFY_INSURE_PASS	9									//修改银行密码
#define SUB_GR_QUERY_TRANSRECORD	10									//转账记录
...
#define SUB_GR_VERIFY_INSURE_PASS_SUCCESS	104							//验证成功
#define SUB_GR_VERIFY_INSURE_PASS_FAILURE	105							//验证失败
#define SUB_GR_WECHAT_CODE	106											//微信验证码
#define SUB_GR_WECHAT_CODE_FAILURE	107									//微信验证码失败
#define SUB_GR_WECHAT_CODE1	108											//微信验证码
#define SUB_GR_MODIFY_INSURE_PASS_SUCCESS	109							//修改银行密码成功
#define SUB_GR_MODIFY_INSURE_PASS_FAILURE	110							//悠银行密码失败
#define SUB_GR_TRANS_RECORD         200                                 //转账记录
//////////////////////////////////////////////////////////////////////////////////

//验证密码
struct CMD_GR_VerifyInsurePass
{
	DWORD							dwUserID;							//用户 I D
...
//验证密码失败
struct CMD_GR_VerifyInsurePassFailure
{
...
//修改密码
struct CMD_GR_ModifyInsurePass
{
	DWORD							dwUserID;							//用户 I D
...
//修改密码失败
struct CMD_GR_ModifyInsurePassFailure
{
	LONG							lResultCode;						//错误代码
	TCHAR							szDescribeString[128];				//错误消息
};
...
//微信验证码
struct CMD_GR_S_WeChatCode
{
	CMD_GR_C_TakeScoreRequest	    takeScore;
	DWORD								dwCode;		
};

struct CMD_GR_C_WeChatCodeFailure
{
	TCHAR							szDescribeString[128];				//描述消息
};
...
//微信验证码
struct CMD_GR_S_WeChatCode1
{
	CMD_GP_C_TransferScoreRequest	    transferScore;
	DWORD								dwCode;		
};
//查询用户
...
//Game 2016-6-17 转账记录
//查询银行
struct CMD_GR_C_QueryInsureTransRecord
{
	BYTE                            cbActivityGame;                     //游戏动作
