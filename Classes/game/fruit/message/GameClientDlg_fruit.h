#pragma once
#include "game/fruit/ui/MainScene_fruit.h"
...
namespace fruit{
	...
	public:
		...
		MainScene_fruit * fruit_mainScene;
		//网络消息
	...
	protected:
		...
		bool OnSubQueryStorage(void * pBuffer, WORD wDataSize);
		bool OnSubChangeGold(void * pBuffer, WORD wDataSize); //兑换金币
		bool OnSubButtonLeft(void * pBuffer, WORD wDataSize); //左移金币
		bool OnSubCompare(void * pBuffer, WORD wDataSize); //左移金币
		bool OnSubButtonRight(void * pBuffer, WORD wDataSize); //右移金币或者结束猜大小
