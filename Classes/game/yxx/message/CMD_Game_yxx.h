#ifndef CMD_BACCARAT_HEAD_FILE_yxx
#define CMD_BACCARAT_HEAD_FILE_yxx
#include "sdk/sdk.h"
#pragma pack(1)
namespace yxx{
	//////////////////////////////////////////////////////////////////////////
...
#define GAME_NAME					TEXT("鱼虾蟹")						//游戏名字
...
#define SERVER_LEN					32									//房间长度
	...
	//			24, 24, 24, 24, 24, 24
	//		};
	//		TCHAR szTmpCfgFileName[MAX_PATH] = _T("yxxBattleConfig.ini");
	//
	//		nMaxTime = 2;
...
#define SUB_S_REPEAT_PLACE_JETTON   124									//2017-5-22 复投成功
...
#define SUB_C_REPEAT_JETTON			8									//复投下注
...
#define RQ_PRINT_SYN		3
	...
	//2017-7-14 客户端传送结构体
	struct CMD_C_RepeatBet
	{
		LONGLONG					lBetScoreAry[AREA_COUNT];			//复投金额数组
	};
	...
	{
		WORD		wChairID;					//用户位置
		LONGLONG	lJettonScore[AREA_COUNT];	//加注数目
	};
}
//////////////////////////////////////////////////////////////////////////
